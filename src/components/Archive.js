      ...
      <Container>
        ...
        <div className="archive__StyledTableContainer-sc-2cxdc9-0 kgfDTC table-style">
          <table>
            ...
            <tbody>
              <tr>
                <td className="overline year">2022</td>
                <td className="title">The Global Wings Charity</td>
                <td className="company hide-on-mobile">
                  <span>Freelance</span>
                </td>
                <td className="tech hide-on-mobile">
                  <span>
                    MERN Stack <span className="seprator">.</span>
                  </span>
                </td>
                <td className="links">
                  <div>
              ...
              <tr>
                <td className="overline year">2022</td>
                <td className="title">
                  The Rooster King Restaurant (Vadalli) Mobile App
                </td>
                <td className="company hide-on-mobile">
                ...
                <td className="tech hide-on-mobile">
                  <span>
                    React Native <span className="seprator">.</span>
                  </span>
                </td>
                <td className="links">
                  <div>
              ...
              <tr>
                <td className="overline year">2022</td>
                <td className="title">Mayuraa Matrimony Mobile App</td>
                <td className="company hide-on-mobile">
                  <span>Aarthy HQC</span>
                </td>
                <td className="tech hide-on-mobile">
